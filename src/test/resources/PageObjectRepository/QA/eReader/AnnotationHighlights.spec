...
annotateModePopUp                           xpath                       //div[contains(@class,'js-annotation-mode-modal')]
annotateModeModalDialog                     xpath                       //div[contains(@class,'js-annotation-mode-modal')]//div[@class='modal-content']
...
search_result								xpath    					//div[not(@style = 'display: none;') and @class='annotation-card']//span[@class='result']
...
backButton                                  xpath                       //*[@class='span-back']
...
last_select_color_span                      css                         div[class^='annotation-flyout create-flyout']>div:nth-child(2) span.last-type>svg
...
divs_under_annotation_wrapper               css                         div[class^='annotations-wrapper '] div[class^='annotation']
last_pagenumber								css							footer div.pages span[class*='total']
cbm_yellowhighlight							css							.shapes-wrapper>div>svg>ellipse
last_chosen_color                           css                         div[class^='annotation-flyout create-flyout'] span[class=last-type]>svg
