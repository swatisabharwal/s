...
cbm_yellowhighlight							css							#Mn-ContentSliderView>div:nth-child(5)>.shapes-wrapper>div>span[class*='shape-a']
last_chosen_color                           css                         div[class^='annotation-flyout create-flyout']>div:nth-child(3) span[class=last-type]>*
