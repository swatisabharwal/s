...
#Object Definitions
====================================================================================
video								   xpath			 //div[@class='videoHolder']
...
total_time_duration_video              xpath            //div[contains(@class,'durationLabel')]
...
active_cc_option					   xpath			//ul[@class='dropdown-menu open']/li[contains(@class,'active')]/a
...
kaltura_spinner							id				loadingSpinner_kaltura_player_1
video_source_List						xpath			.//p[@class='video-source']//word
====================================================================================
...
current_time_duration_video:
      near: total_time_duration_video -1px left
