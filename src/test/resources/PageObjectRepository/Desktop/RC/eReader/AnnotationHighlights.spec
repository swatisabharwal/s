...
last_select_color_span                      css                         div[class^='annotation-flyout create-flyout']>div:nth-child(2) span.last-type
...
note_cards_parenets                         xpath                       //div[contains(@class,'annotations-wrapper ')]//div[@class='annotation-card']/parent::div
